    ...
    <div className="mx-auto max-w-lg space-y-6 py-2">
      ...
      <div className="flex flex-col items-center text-center">
        <div className="relative flex h-24 w-24 items-center justify-center">
          <span className="absolute inset-0 animate-ping rounded-full bg-teal-100 opacity-40" />
          <span className="relative flex h-16 w-16 items-center justify-center rounded-full bg-teal-50 ring-4 ring-teal-100">
            <svg className="h-8 w-8 text-teal-600" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" aria-hidden>
