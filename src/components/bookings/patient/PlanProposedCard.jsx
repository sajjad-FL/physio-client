  ...
  return (
    <Card hover={false} className="border-teal-100 bg-teal-50/30 p-5 sm:p-6">
      <div className="flex items-start gap-3">
        ...
        <div>
          <h2 className="text-base font-semibold text-slate-900">Treatment Plan Proposed</h2>
          <p className="mt-0.5 text-sm text-slate-600">Review the details below and approve to proceed</p>
        </div>
      </div>
