...
const imgOrthopedic = '/images/specialty_orthopedic.png'
const imgNeuro = '/images/specialty_neuro.png'
const imgPediatric = '/images/illustration_pediatric.png'
const imgPostOp = '/images/specialty_post_op.png'
const imgElderly = '/images/technique_elderly.png'
const imgOtherSpec = '/images/specialty_other.png'
const imgBackPain = '/images/illustration_back_pain.png'
const imgKneePain = '/images/illustration_knee_pain.png'
const imgNeckPain = '/images/illustration_neck_pain.png'
const imgStroke = '/images/illustration_neuro_rehab.png'
const imgOther = '/images/illustration_other.png'
