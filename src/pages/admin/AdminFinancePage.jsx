...
export default function AdminFinancePage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-gray-900">Finance &amp; payments</h1>
        <p className="mt-1 text-sm text-gray-500">
          Consolidated control center: manage wallets, check offline cash payment queue, and process payouts.
        </p>
      </div>
