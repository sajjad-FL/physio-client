        ...
        <form onSubmit={saveProduct} className="mb-6 rounded-2xl border border-border-subtle bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2">
              <label className="mb-1 block text-xs font-medium text-ink-muted">Product name</label>
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-ink-muted">Price (₹)</label>
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-ink-muted">Stock</label>
            ...
            <div className="sm:col-span-2">
              <label className="mb-1 block text-xs font-medium text-ink-muted">Photos (up to 6)</label>
