...
export function useProfileCompletionPoller(enabled = true) {
  ...
  useEffect(() => {
    ...
    async function initialFetch() {
      ...
      try {
        ...
        const complete = applyProfileData(data)
  ...
  }, [enabled, applyProfileData, clearPoller])
